...
from clustercontrast.models.feature_calibration import FCM
    ...
    for epoch in range(args.epochs):
        with torch.no_grad():
            ...
            for i in range(args.layers):
                features = fcm(features, k=args.k, w=args.w)
        ...
        if (epoch + 1) % args.eval_step == 0 or (epoch == args.epochs - 1):
            ...
            save_checkpoint({
                ...
                'epoch': epoch + 1,
                'best_mAP': best_mAP,
            }, is_best, fpath=osp.join(args.logs_dir, 'checkpoint' + str(epoch+1) + '.pth.tar'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pp', '--pretrained-path', type=str, default='/home/ps/D/data-1/hqs/2023_v2/vit_small_cfs_lup.pth')
    # /home/a/data/hqs/reid_data/vit_small_cfs_lup.pth
    parser.add_argument('--resume', type=str,
                        default="/home/ps/D/data-1/hqs/2023_v2/code7/cluster-contrast-reid-base/model_best.pth.tar",
                        metavar='PATH')
    # /home/ps/D/data-1/hqs/2023_v2_2/code1/TransReID-SSL-main-base/log_base/msmt1/model_best.pth.tar  44.2
    # /home/ps/D/data-1/hqs/2023_v2_2/code1/TransReID-SSL-main-base/log_base/market1/checkpoint50.pth.tar 88.1
    ...
    parser.add_argument('--self-norm', action="store_true", default=True)
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH', default='/home/ps/D/data-1/reid_data')
    parser.add_argument('--logs-dir', type=str, metavar='PATH', default='./log_test')
