...
# VIT-S
CUDA_VISIBLE_DEVICES=0 python examples/cluster_contrast_train_usl.py -b 256 -a vit_small -d msmt17 --iters 200 --eps 0.7 --self-norm --use-hard --hw-ratio 2 --num-instances 8 \
-pp /home/a/data/hqs/reid_data/vit_small_cfs_lup.pth --logs-dir ./log_base/msmt1 --eval-step 50
